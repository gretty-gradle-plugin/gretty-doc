...
| String
| 'jetty9'
| Servlet container to be used in appXXX tasks. Possible values are 'jetty7', 'jetty8', 'jetty9', 'jetty9.3' (jdk 8 only), 'jetty9.4' (jdk 8 only), 'tomcat7' (Gretty < 3.0), 'tomcat8' (Gretty < 3.0).
