...
Gretty sources contain https://github.com/gretty-gradle-plugin/gretty/tree/master/integrationTests/extraResourceBases[example program] demonstrating web-app extra resource bases at work.
